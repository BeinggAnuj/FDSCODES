...
Output
//
1. Registering a Passenger (User Input via GUI):
...
John registered for USA at 06:00 AM. Ticket Price: ₹50000.
//
2. Registering Another Passenger:
...
Alice registered for France at 10:00 PM. Ticket Price: ₹35000.
//
3. Viewing the Current Passenger Queue:

Output in the GUI:

Current Passenger Queue:
- John, Destination: USA, Time: 06:00 AM, Price: ₹50000
- Alice, Destination: France, Time: 10:00 PM, Price: ₹35000

//
4. Boarding the First Passenger:

Output in the GUI:

John boarded the flight to USA at 06:00 AM. Ticket Price: ₹50000.

//
5. Viewing the Queue After Boarding:
...
//
6. Boarding the Last Passenger:

Output in the GUI:
Alice boarded the flight to France at 10:00 PM. Ticket Price: ₹35000.
//

7. Trying to Board with an Empty Queue:
